...
.bright-hover tr:hover td {
  background-color: @table-bg-bright-hover;
}
...
.linearGauge {
  ...
  .ranges {
    ...
    left: 5px;
    overflow: hidden;
    border: 5px solid @component-background;
    border-radius: 40px;
  }
}
...
// .grid-stack-item-content .c8yGraphContainer {
//   position:absolute;
//   top: 40px;
//   right:10px;
//   bottom:0;
...
// }
.nv-pieLabels text {
  fill: @component-background !important;
}
