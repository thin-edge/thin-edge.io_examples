...
.c8y-list__item {
  display: block;
  .component-setup();
  .component-vars(c8y-list-group);
  .use-display-density();
  .shadow-border(-1px, @component-border);
  &.disabled {
    opacity: 0.5;
    pointer-events: none;
  }
  ...
  .c8y-list__group--strip & {
    &:nth-child(odd) {
      background: @component-odd-background;
    }
  }
...
.c8y-list__item__collapse--container {
  background-image: @component-expanded-gradient;
  padding: @component-padding;
  @media (min-width: @screen-md-min) {
    padding: @component-padding 4rem 2rem;
  }
...
.c8y-list--timeline {
  ...
  .c8y-list--timeline__item {
    ...
    .c8y-list__item {
      ...
      transition: background 1s linear 0.25s, border 1s linear 0.25s;
    ...
    &.ng-enter {
      &:after {
        transition: none;
        background: @realtime-added-element-color!important;
      }
      .c8y-list__item {
        transition: none;
        background: @realtime-added-element-color!important;
  ...
  .c8y-list__item {
    ...
    &::after {
      ...
      border-width: 10px 10px 10px 0;
      border-style: solid;
      border-color: transparent var(--component-background, var(--root-component-background, white))
