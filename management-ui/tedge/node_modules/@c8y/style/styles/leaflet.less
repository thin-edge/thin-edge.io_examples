...
.leaflet-container a.leaflet-active {
  outline: 2px solid @orange-7;
}

.leaflet-zoom-box {
  border: 2px dotted @brand-primary-css-var;
...
.leaflet-container {
  font: 12px/1.5 @font-family-base;
}
...
.leaflet-popup-content {
  ...
  .text-muted {
    color: @component-text-muted!important;
  }
  a {
    color: @component-link-color!important;
    &:hover {
      color: @component-link-color-hover!important;
    }
  }
}
...
.leaflet-container a.leaflet-popup-close-button {
  ...
  color: @component-actions-color!important;
  text-align: center;
  text-decoration: none;
  font-weight: bold;
}
