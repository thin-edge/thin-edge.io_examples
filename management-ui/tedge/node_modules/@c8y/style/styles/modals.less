...
// Fixing nested backdrop issue in ngx-bootstrap
// https://github.com/valor-software/ngx-bootstrap/issues/5000
modal-container {
...
.modal-map {
  ...
  .panel-map {
    ...
    padding: 30px 15px;
    width: 200px;
    background-color: rgba(@component-background, 0.9);
  }
}
