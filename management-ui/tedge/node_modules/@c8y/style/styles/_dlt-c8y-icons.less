@font-face {
  ...
  src: url('@{asset-directory}/@{icon-font-family}.ttf?h14sn6') format('truetype'),
    url('@{asset-directory}/@{icon-font-family}.woff?h14sn6') format('woff'),
    url('@{asset-directory}/@{icon-font-family}.svg?h14sn6#@{icon-font-family}') format('svg');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
...
[class^="dlt-c8y-icon-"], [class*=" dlt-c8y-icon-"], .dlt-c8y-icon {
