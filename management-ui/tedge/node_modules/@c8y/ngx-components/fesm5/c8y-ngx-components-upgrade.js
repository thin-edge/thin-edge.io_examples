...
import { ViewContext, EmptyComponent, gettext, AppStateService, RouterService, ActionService, TabsService, DatePipe, RouterModule, HOOK_NAVIGATOR_NODES, HOOK_TABS, HOOK_ACTION_BAR, HOOK_ACTION, HOOK_BREADCRUMB, HOOK_DOCS, BootstrapComponent, UserTotpRevokeComponent, DataGridComponent, LoadingComponent, RangeDisplayComponent, HelpComponent, HOOK_PATTERN_MESSAGES, HeaderService, AlertService, UserMenuService, DocsService, PasswordService, CachedLocaleDictionaryService, NavigatorNodeRoot, getActivatedRoute, ActionBarService, WidgetsDashboardComponent, C8yTranslateModule, HOOK_COMPONENTS } from '@c8y/ngx-components';
...
import { map, unary, find, forEach, startsWith, assign, pick, property, some, every, get } from 'lodash-es';
...
var loadingComponent = downgradeComponent({ component: LoadingComponent });
var rangeDisplayComponent = downgradeComponent({ component: RangeDisplayComponent });
var helpComponent = downgradeComponent({ component: HelpComponent });
...
var absoluteDateService = downgradeInjectable(AbsoluteDateService);
