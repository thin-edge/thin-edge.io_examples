...
import { DeviceGridColumn, DeviceGridColumnFilteringConfig, DeviceGridColumnSortingConfig } from '../device-grid.models';
export declare class BaseDeviceGridColumn implements DeviceGridColumn {
    name: string;
    path?: string;
    header?: string;
