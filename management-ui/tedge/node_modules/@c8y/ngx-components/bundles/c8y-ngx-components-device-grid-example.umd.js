(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@c8y/ngx-components/device-grid'), require('@c8y/ngx-components'), require('lodash-es'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/device-grid-example', ['exports', '@angular/core', '@c8y/ngx-components/device-grid', '@c8y/ngx-components', 'lodash-es', '@angular/router'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components']['device-grid-example'] = {}), global.ng.core, global.c8y['ngx-components']['device-grid'], global.c8y['ngx-components'], global.lodashEs, global.ng.router));
}(this, (function (exports, core, deviceGrid, ngxComponents, lodashEs, router) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DeviceGridExampleComponent = /** @class */ (function () {
        ...
        DeviceGridExampleComponent.prototype.getExampleWithStandardColumnsAndSavedFilteringSorting = function () {
            var columns = this.deviceGridService.getDefaultColumns();
            var nameColumn = lodashEs.find(columns, { name: 'name' });
        ...
        DeviceGridExampleComponent.prototype.getExampleWithCustomColumnAndPredefinedFiltering = function () {
            var columns = this.deviceGridService.getDefaultColumns();
            var typeColumn = new deviceGrid.CustomDeviceGridColumn();
            typeColumn.name = 'type';
            typeColumn.path = 'type';
            typeColumn.header = ngxComponents.gettext('Type');
    ...
    var DeviceGridExampleNavigationFactory = /** @class */ (function () {
        function DeviceGridExampleNavigationFactory(deviceGridExampleGuard) {
            this.deviceGridExampleGuard = deviceGridExampleGuard;
        }
        DeviceGridExampleNavigationFactory.prototype.get = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!this.nav && this.deviceGridExampleGuard.canActivate(null, null)) {
                        this.nav = new ngxComponents.NavigatorNode({
                            label: ngxComponents.gettext('Grids'),
                            icon: 'table'
                        });
                        this.nav.add(new ngxComponents.NavigatorNode({
                            label: ngxComponents.gettext('Device grid'),
        ...
        DeviceGridExampleNavigationFactory.ctorParameters = function () { return [
            { type: DeviceGridExampleGuard }
        ]; };
        DeviceGridExampleNavigationFactory = __decorate([
            core.Injectable()
        ], DeviceGridExampleNavigationFactory);
        return DeviceGridExampleNavigationFactory;
    }());
    ...
    var DeviceGridExampleModule = /** @class */ (function () {
        ...
        DeviceGridExampleModule = __decorate([
            core.NgModule({
                imports: [
                    ngxComponents.CoreModule,
                    ngxComponents.CommonModule,
                    deviceGrid.DeviceGridModule,
                    router.RouterModule.forRoot(routes, { useHash: true })
                ],
    ...
    exports.DeviceGridExampleComponent = DeviceGridExampleComponent;
    exports.DeviceGridExampleGuard = DeviceGridExampleGuard;
    exports.DeviceGridExampleModule = DeviceGridExampleModule;
    exports.DeviceGridExampleNavigationFactory = DeviceGridExampleNavigationFactory;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=c8y-ngx-components-device-grid-example.umd.js.map
