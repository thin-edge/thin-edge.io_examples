(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@c8y/ngx-components')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/ecosystem', ['exports', '@angular/core', '@angular/router', '@c8y/ngx-components'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components'].ecosystem = {}), global.ng.core, global.ng.router, global.c8y['ngx-components']));
}(this, (function (exports, core, router, ngxComponents) { 'use strict';
    ...
    ***************************************************************************** */
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    if (this.navs.length === 0) {
                        applicationsNode = new ngxComponents.NavigatorNode({
                            label: ngxComponents.gettext('Applications'),
                            icon: 'c8y-modules',
                            path: '/application-list'
                        });
                        microservicesNode = new ngxComponents.NavigatorNode({
                            label: ngxComponents.gettext('Microservices'),
                            icon: 'microchip',
                            path: '/microservices'
                        });
                        this.navs.push(new ngxComponents.NavigatorNode({
                            label: ngxComponents.gettext('Ecosystem'),
                            icon: 'c8y-atom',
                            priority: 3200,
    ...
    var EcosystemModule = /** @class */ (function () {
        ...
        EcosystemModule = __decorate([
            core.NgModule({
                ...
                imports: [ngxComponents.CoreModule, router.RouterModule.forRoot(ecosystemRoutes, { useHash: true })],
                providers: [
                    {
    ...
    exports.ɵb = MicroserviceListComponent;
    exports.ɵc = EcosystemGuard;
    exports.ɵd = EcosystemNavigationFactory;
