(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash-es'), require('ngx-bootstrap/modal'), require('rxjs'), require('rxjs/operators'), require('@c8y/ngx-components'), require('@ngx-translate/core'), require('@angular/router'), require('@c8y/client'), require('@angular/forms'), require('ngx-bootstrap/dropdown'), require('ngx-bootstrap/tooltip'), require('ngx-bootstrap/popover')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/context-dashboard', ['exports', '@angular/core', 'lodash-es', 'ngx-bootstrap/modal', 'rxjs', 'rxjs/operators', '@c8y/ngx-components', '@ngx-translate/core', '@angular/router', '@c8y/client', '@angular/forms', 'ngx-bootstrap/dropdown', 'ngx-bootstrap/tooltip', 'ngx-bootstrap/popover'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components']['context-dashboard'] = {}), global.ng.core, global.lodashEs, global.modal, global.rxjs, global.rxjs.operators, global.c8y['ngx-components'], global.core$1, global.ng.router, global.client, global.ng.forms, global.dropdown, global.tooltip, global.popover));
}(this, (function (exports, core, lodashEs, modal, rxjs, operators, ngxComponents, core$1, router, client, forms, dropdown, tooltip, popover) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ContextDashboardService = /** @class */ (function () {
        ...
        ContextDashboardService.prototype.updateNavigatorItem = function (mo) {
            ...
            if (mo.c8y_IsNavigatorNode) {
                var nodeToAdd = new ngxComponents.NavigatorNode({
                    label: mo.name,
                    path: "reports/" + mo.id,
                    icon: mo.icon,
        ...
        ContextDashboardService.prototype.isReport = function (dashboard) {
            var _this = this;
            return lodashEs.some(lodashEs.keys(dashboard), function (prop) {
                return new RegExp("^" + _this.FRAGMENT_NAME + _this.INDEX_SPLIT + exports.ContextDashboardType.Named + _this.INDEX_SPLIT + _this.REPORT_PARTIAL_NAME).test(prop);
            });
        };
    ...
    var WidgetConfigComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('config', { static: false })
    ...
    var DashboardDetailComponent = /** @class */ (function () {
        ...
        DashboardDetailComponent.prototype.ngAfterContentInit = function () {
            ...
            this.namePlaceholder = this.isReport ? ngxComponents.gettext('e.g. My report') : ngxComponents.gettext('e.g. My dashboard');
        };
        DashboardDetailComponent.prototype.setTitle = function () {
            this.titleName = this.isReport ? ngxComponents.gettext('report') : ngxComponents.gettext('dashboard');
            this.titleAction = this.current ? ngxComponents.gettext('Edit') : ngxComponents.gettext('Add');
        };
    ...
    var ContextDashboardComponent = /** @class */ (function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            cfg = _b.sent();
                            if (isReport) {
                                name_2 = cfg.name, icon = cfg.icon, c8y_IsNavigatorNode = cfg.c8y_IsNavigatorNode, priority = cfg.priority, description = cfg.description, dashboardCfg = __rest(cfg, ["name", "icon", "c8y_IsNavigatorNode", "priority", "description"]);
        ...
        ContextDashboardComponent.prototype.mergeWidgetClasses = function (widget) {
            ...
            return __assign((_a = { card: true, 'card-dashboard': true }, _a[lodashEs.kebabCase(widget.componentId || widget.name)] = true, _a), widgetClasses);
        };
        ...
        ContextDashboardComponent.ctorParameters = function () { return [
            ...
            { type: client.InventoryService },
            { type: ngxComponents.GainsightService }
        ]; };
        __decorate([
            core.Input()
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1: return [2 /*return*/, ((_a.sent()) && [ngxComponents.ViewContext.Device, ngxComponents.ViewContext.Group].includes(context.context))];
    ...
    var ReportDashboardService = /** @class */ (function () {
        ...
        ReportDashboardService.prototype.addReportNavigatorNode = function (report) {
            var node = new ngxComponents.NavigatorNode({
                label: report.name,
    ...
    var ReportDashboardListComponent = /** @class */ (function () {
        function ReportDashboardListComponent(inventoryService, contextDashboardService, bsModal, translateService, modal, alertService, reportDashboardService) {
            ...
            this.DELETED_SUCCESS_MSG = ngxComponents.gettext('Report deleted.');
        }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            cfg = _a.sent();
                            name_1 = cfg.name, icon = cfg.icon, c8y_IsNavigatorNode = cfg.c8y_IsNavigatorNode, priority = cfg.priority, description = cfg.description, dashboardCfg = __rest(cfg, ["name", "icon", "c8y_IsNavigatorNode", "priority", "description"]);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            msg = ngxComponents.gettext("You are about to delete the report \"{{ reportName }}\". Do you want to proceed?");
                            return [4 /*yield*/, this.modal.confirm(ngxComponents.gettext('Delete report'), this.translateService.instant(msg, {
    ...
    var WelcomeToCockpit = /** @class */ (function () {
        ...
        WelcomeToCockpit.prototype.createQuickLinkReports = function () {
            var _this = this;
            var label = ngxComponents.gettext('Reports');
            var reports = {
                icon: 'th',
                label: label,
                url: '/reports'
        ...
        WelcomeToCockpit.prototype.createQuickLinkExports = function () {
            var _this = this;
            var label = ngxComponents.gettext('Exports');
            var exports = {
                icon: 'c8y-reports',
                label: label,
                url: '/export'
        ...
        WelcomeToCockpit.prototype.createQuicklinkSmartRules = function () {
            var _this = this;
            var label = ngxComponents.gettext('Smart rules');
            var smartRules = {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.loaded = true;
                            this.navigatorService.add(new ngxComponents.NavigatorNode({
    ...
    var ɵ0$1 = [
        {
            ...
            context: ngxComponents.ViewContext.Report
        }
    ];
