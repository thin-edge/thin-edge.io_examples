(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@c8y/ngx-components'), require('rxjs'), require('rxjs/operators'), require('@angular/router'), require('@c8y/client'), require('@angular/forms'), require('ngx-bootstrap/popover'), require('lodash-es')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/connectivity', ['exports', '@angular/core', '@c8y/ngx-components', 'rxjs', 'rxjs/operators', '@angular/router', '@c8y/client', '@angular/forms', 'ngx-bootstrap/popover', 'lodash-es'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components'].connectivity = {}), global.ng.core, global.c8y['ngx-components'], global.rxjs, global.rxjs.operators, global.ng.router, global.client, global.ng.forms, global.popover, global.lodashEs));
}(this, (function (exports, core, ngxComponents, rxjs, operators, router, client, forms, popover, lodashEs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AbstractConnectivityTabFactory = /** @class */ (function () {
        ...
        AbstractConnectivityTabFactory.prototype.tab = function () {
            var _this = this;
            return this.wrapIntoObservable(this.guard.canActivate(this.router.routerState.snapshot.root, this.router.routerState.snapshot)).pipe(operators.map(function (canActivate) { return (canActivate ? _this.config() : null); }));
        };
    ...
    var AbstractConnectivityNodeFactory = /** @class */ (function () {
        ...
        AbstractConnectivityNodeFactory.prototype.get = function () {
            var _this = this;
            return this.wrapIntoObservable(this.tabFactory.tab()).pipe(operators.map(function (tab) {
        ...
        AbstractConnectivityNodeFactory = __decorate([
            core.Injectable()
    ...
    var ActilityGuard = /** @class */ (function () {
        ...
        ActilityGuard = ActilityGuard_1 = __decorate([
            core.Injectable()
        ], ActilityGuard);
    ...
    var ActilityNodeFactory = /** @class */ (function (_super) {
        ...
        ActilityNodeFactory = __decorate([
            core.Injectable()
        ], ActilityNodeFactory);
    ...
    var ImpactConnectivityService = /** @class */ (function () {
        ...
        ImpactConnectivityService = __decorate([
            core.Injectable()
    ...
    var ImpactGuard = /** @class */ (function () {
        ...
        ImpactGuard = ImpactGuard_1 = __decorate([
            core.Injectable()
        ], ImpactGuard);
        return ImpactGuard;
    }());
    ...
    var ImpactProviderSettingsComponent = /** @class */ (function () {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (this.connectionStatus && this.connectionStatus.options) {
                                this.formGroup.patchValue(__assign({}, this.connectionStatus.options));
        ...
        ImpactProviderSettingsComponent = __decorate([
            core.Component({
    ...
    var SigfoxGuard = /** @class */ (function () {
        ...
        SigfoxGuard = SigfoxGuard_1 = __decorate([
            core.Injectable()
        ], SigfoxGuard);
        return SigfoxGuard;
    }());
    ...
    var SimGuard = /** @class */ (function () {
        ...
        SimGuard = SimGuard_1 = __decorate([
            core.Injectable()
        ], SimGuard);
        return SimGuard;
    }());
