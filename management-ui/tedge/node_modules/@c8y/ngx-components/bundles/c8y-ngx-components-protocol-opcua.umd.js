(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/protocol-opcua', ['exports', '@angular/core', '@angular/forms', 'lodash-es', '@c8y/client', 'rxjs', '@angular/router', '@c8y/ngx-components', '@angular/upgrade/static', '@angular/cdk/tree', 'ngx-bootstrap/buttons', 'lodash', '@ngx-translate/core', 'ngx-bootstrap/collapse', 'ngx-bootstrap/dropdown', 'ngx-bootstrap/tooltip', 'ngx-bootstrap/popover', 'rxjs/operators', '@angular/platform-browser/animations', 'angular', '@c8y/ng1-modules/core/bootstrap'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components']['protocol-opcua'] = {}), global.ng.core, global.ng.forms, global.lodashEs, global.client, global.rxjs, global.ng.router, global.c8y['ngx-components'], global.ng.upgrade.static, global.ng.cdk.tree, global.buttons, global.lodash, global.core$1, global.collapse, global.dropdown, global.tooltip, global.popover, global.rxjs.operators, global.ng.platformBrowser.animations, global.angular, global.bootstrap));
}(this, (function (exports, core, forms, lodashEs, client, rxjs, router, ngxComponents, _static, tree, buttons, lodash, core$1, collapse, dropdown, tooltip, popover, operators, animations, angular, bootstrap) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var OpcuaDeviceProtocolMappingCustomAction = /** @class */ (function () {
        ...
        OpcuaDeviceProtocolMappingCustomAction.prototype.ngOnInit = function () {
            if (lodashEs.get(this.customAction, 'endpoint')) {
        ...
        OpcuaDeviceProtocolMappingCustomAction = __decorate([
            core.Component({
                ...
                viewProviders: [{ provide: forms.ControlContainer, useExisting: forms.NgModelGroup }]
            })
    ...
    var AddressSpaceService = /** @class */ (function () {
        function AddressSpaceService(fetchClient) {
            ...
            this.nodeNavigationData$ = new rxjs.BehaviorSubject({
                node: undefined,
                selectedAncestorIds: []
            });
        }
    ...
    var OpcuaAddressSpaceDetailComponent = /** @class */ (function () {
        function OpcuaAddressSpaceDetailComponent(addressSpaceService) {
            ...
            this.toggleAttrDetail = new core.EventEmitter();
        }
        ...
        OpcuaAddressSpaceDetailComponent.prototype.setNodeData = function (nodeData) {
            ...
            this.nodeDataAttr = Object.assign({}, attributes, lodashEs.omit(nodeData, omitList));
        };
    ...
    var OpcuaDeviceProtocolBrowsePathValidation = /** @class */ (function () {
        ...
        OpcuaDeviceProtocolBrowsePathValidation.prototype.isValidJson = function (value) {
            try {
                ...
                return !lodashEs.isEmpty(browsePath);
            }
            catch (error) {
                return false;
            }
        ...
        OpcuaDeviceProtocolBrowsePathValidation.prototype.isBrowsePathUnique = function (value) {
            ...
            var found = lodashEs.some(mappings, function (item) {
                if (lodashEs.isEqual(item.browsePath, _this.toArray(value)) && item.id !== _this.model.id) {
                    return item;
                }
            });
                ...
                providers: [
                    {
                        ...
                        useExisting: core.forwardRef(function () { return OpcuaDeviceProtocolBrowsePathValidation_1; }),
                        multi: true
                    }
                ]
            })
    ...
    var OpcuaDeviceProtocolMapping = /** @class */ (function () {
        ...
        OpcuaDeviceProtocolMapping.prototype.ngOnChanges = function (changes) {
            if (changes._model.previousValue &&
                !lodashEs.isEqual(this._model, changes._model.previousValue.SimpleChange)) {
        ...
        OpcuaDeviceProtocolMapping.prototype.initialFormSetup = function () {
            ...
            this.mapping = lodashEs.assign({}, mapping, lodashEs.cloneDeep(this._model));
            if (lodashEs.isEmpty(this.mapping.browsePath)) {
                this.isNew = true;
            ...
            if (lodashEs.get(this.mapping, 'customAction')) {
                this.customAction = lodashEs.assign(customAction, lodashEs.get(this.mapping, 'customAction'));
                this.customAction.headers = this.mapHeadersObjectToList(lodashEs.get(this.customAction, 'headers'));
            }
            else {
                this.customAction = lodashEs.assign({}, customAction);
            }
            lodashEs.unset(this.mapping, 'customAction');
            if (lodashEs.get(this._model, 'subscriptionType')) {
        ...
        OpcuaDeviceProtocolMapping.prototype.showAddressSpaceTree = function () {
            return !lodashEs.isEmpty(this.referencedServerId);
        };
        OpcuaDeviceProtocolMapping.prototype.ngAfterViewInit = function () {
            if (lodashEs.get(this.mapping, 'subscriptionType') &&
                lodashEs.get(this.mapping, 'subscriptionType.type') !== 'None') {
                this.dataReporting = 'custom';
            }
        };
        ...
        OpcuaDeviceProtocolMapping.prototype.save = function () {
            if (this.dataReporting === 'default') {
                lodashEs.unset(this.mapping, 'subscriptionType');
            }
            if (lodashEs.get(this.mapping, 'measurementCreation')) {
                var measurementCreation = this.mapping.measurementCreation;
                lodashEs.set(measurementCreation, 'fragmentName', lodashEs.get(measurementCreation, 'type'));
            }
            ...
            if (customAction.hasCustomAction) {
                ...
                modifiedCustomAction = lodashEs.assign({}, this.customAction, { headers: reducedHeaders });
            }
            this.onAction.emit({
                action: 'save',
                data: lodashEs.assign({}, this.mapping, { customAction: modifiedCustomAction })
            });
        ...
        OpcuaDeviceProtocolMapping.prototype.cancel = function () {
            ...
            if (this.mapping.id === 'new') {
                this.onAction.emit({ action: 'delete', data: lodashEs.assign({}, this.mapping) });
            }
        };
        ...
        __decorate([
            core.ViewChild(OpcuaDeviceProtocolObjectMapping, { static: false })
        ], OpcuaDeviceProtocolMapping.prototype, "objectMappingForm", void 0);
        __decorate([
            core.ViewChild('variableForm', { static: false })
        ], OpcuaDeviceProtocolMapping.prototype, "subFormRef", void 0);
        __decorate([
            core.ViewChild('browsePathModel', { static: false })
    ...
    var OpcuaDeviceProtocolDetailComponent = /** @class */ (function () {
        function OpcuaDeviceProtocolDetailComponent(changeDetectorRef, opcuaService, alertService, router) {
            ...
            this.isLoaded = true;
            this.getParentAttr = function (key) { return lodash.get(_this.model, key); };
        }
        ...
        OpcuaDeviceProtocolDetailComponent.prototype.getOverriddenSubscriptionsByPath = function (browsePath) {
            return lodash.find(this.model.overriddenSubscriptions, { browsePath: browsePath });
        };
        OpcuaDeviceProtocolDetailComponent.prototype.getStructuredResource = function (resource) {
            ...
            var result = lodash.assign({}, resource);
            if (overriddenSubscriptions) {
                result = lodash.assign({}, resource, { subscriptionType: overriddenSubscriptions.subscriptionType });
            }
            return result;
        };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 6:
                            ...
                            this.model = lodash.assign(this.initialModel, data);
                            if (!this.model.mappings) {
                                this.model.mappings = [];
                            }
                            this.model = lodash.assign(this.initialModel, this.updateViableMapping(data));
                            this.isLoaded = false;
                            _b.label = 7;
        ...
        OpcuaDeviceProtocolDetailComponent.prototype.updateViableMapping = function (model) {
            ...
            if (mappings) {
                result = mappings.map(function (item, i) {
                    return lodash.assign(item, { id: i });
                });
            }
            return lodash.assign(model, { mappings: result });
        };
        ...
        OpcuaDeviceProtocolDetailComponent.prototype.updateVariable = function (mappingObject) {
            ...
            var index = lodash.findIndex(mappings, { id: mappingObject.id });
            ...
            _mapping.forEach(function (element) {
                if (element.id !== 'new') {
                    if (element.subscriptionType) {
                        overriddenSubscriptions.push(lodash.assign({ browsePath: element.browsePath }, { subscriptionType: element.subscriptionType }));
                    }
                    variableMapping.push(lodash.omit(element, ['subscriptionType']));
                }
            });
        ...
        OpcuaDeviceProtocolDetailComponent.prototype.prepareRequestJson = function (_model) {
            ...
            requestJson = lodash.assign(requestJson, lodash.pick(_model, Object.keys(this.initialModel)), {
                mappings: mappings,
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (res && res.status === 200) {
                                ...
                                this.alertService.success(ngxComponents.gettext('Device protocol saved.'));
                            }
                            else {
                        ...
                        case 3:
                            ex_1 = _a.sent();
                            this.alertService.danger(ngxComponents.gettext('Failed to save. Try again.'));
                            return [3 /*break*/, 4];
        ...
        __decorate([
            core.ViewChildren(OpcuaDeviceProtocolMapping)
    ...
    var OpcuaDeviceProtocolDataReportingComponent = /** @class */ (function () {
        function OpcuaDeviceProtocolDataReportingComponent() {
            this.onSubscriptionChange = new core.EventEmitter();
            this.subscription = {
                type: 'None'
            };
            ...
            this.types = [
                { value: 'None', label: ngxComponents.gettext('None') },
                { value: 'CyclicRead', label: ngxComponents.gettext('Cyclic read') },
                { value: 'Subscription', label: ngxComponents.gettext('Subscription') }
            ];
            this.filters = [
                { value: 'None', label: ngxComponents.gettext('None') },
                { value: 'absolute', label: ngxComponents.gettext('Absolute') },
                { value: 'percent', label: ngxComponents.gettext('Percent') }
            ];
            this.triggers = [
                { value: 'Status', label: ngxComponents.gettext('Status') },
                { value: 'StatusValue', label: ngxComponents.gettext('Status/Value') },
                { value: 'StatusValueTimestamp', label: ngxComponents.gettext('Status/Value/Timestamp') }
            ];
            this.discard = [
                { value: true, label: ngxComponents.gettext('oldest`data`') },
                { value: false, label: ngxComponents.gettext('newest`data`') }
            ];
            this.requireCyclic = false;
            this.requireSubscription = false;
            this.subscriptionTypeName = 'subscriptionType';
            this.parseReadingInterval = function ($event) { return lodash.toInteger($event.target.value); };
        }
        ...
        OpcuaDeviceProtocolDataReportingComponent.prototype.updateModel = function () {
            var _this = this;
            setTimeout(function () {
                lodash.unset(_this.subscription, 'subscriptionParameters');
                lodash.unset(_this.subscription, 'cyclicReadParameters');
                if (_this.subscription.type === 'CyclicRead') {
                    _this.requireCyclic = true;
                    _this.requireSubscription = false;
                    lodash.set(_this.subscription, 'cyclicReadParameters', _this.cyclicReadParameters);
                }
                else if (_this.subscription.type === 'Subscription') {
                    _this.requireCyclic = false;
                    _this.requireSubscription = true;
                    lodash.set(_this.subscription, 'subscriptionParameters', _this.subscriptionParameters);
                }
    ...
    var OpcuaAddressSpaceComponent = /** @class */ (function () {
        function OpcuaAddressSpaceComponent(addressSpaceService, opcuaService) {
            ...
            this.focusStatus = new core.EventEmitter();
            this.moId = '';
        }
        OpcuaAddressSpaceComponent.prototype.ngOnInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.filterLabel = ngxComponents.gettext('Filter…');
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a.nodeList = _b.sent();
                            this.searchInProgress = false;
                            this.nodeList.resultLabel = ngxComponents.gettext('Results found');
                            _b.label = 2;
    ...
    var OpcuaServerConfigComponent = /** @class */ (function () {
        function OpcuaServerConfigComponent(opcuaService) {
            ...
            this.ANONYM = {
                id: 1,
                value: ngxComponents.gettext('Anonymous')
            };
            this.USER_PASSWORD = {
                id: 2,
                value: ngxComponents.gettext('Username/Password')
            };
            this.KEY_BASED = {
                id: 3,
                value: ngxComponents.gettext('Key-based Authentication')
            };
        ...
        Object.defineProperty(OpcuaServerConfigComponent.prototype, "server", {
            ...
            set: function (server) {
                if (server) {
                    this._server = lodashEs.cloneDeep(server);
                    this.model = lodashEs.cloneDeep(server);
        ...
        OpcuaServerConfigComponent.prototype.updateConnectionStatusLabel = function (server) {
            ...
            var label = connected ? ngxComponents.gettext('Connected') : ngxComponents.gettext('Disconnected');
        ...
        OpcuaServerConfigComponent.prototype.getModelConfig = function (fragment) {
            if (this.model && this.model.config) {
                if (fragment && fragment.length > 0) {
                    return lodashEs.has(this.model.config, fragment) ? this.model.config["" + fragment] : undefined;
                }
            }
            return undefined;
        };
        ...
        __decorate([
            core.ViewChild('opcuaConfigForm', { static: false })
        ], OpcuaServerConfigComponent.prototype, "opcuaConfigForm", void 0);
        __decorate([
            core.ViewChild(ngxComponents.DropAreaComponent, { static: false })
    ...
    var OpcuaServerListComponent = /** @class */ (function () {
        function OpcuaServerListComponent() {
            this.serverList = [];
            this.present = new core.EventEmitter();
        }
    ...
    var OpcuaServersComponent = /** @class */ (function () {
        ...
        OpcuaServersComponent.prototype.setQuickInfo = function (server) {
            ...
            if (server && server.config) {
                if (server.config.securityMode) {
                    ...
                    server.quickInfo.padlockMsg = this.translateService.instant(ngxComponents.gettext('The security policy is set to {{param}}.'), { param: server.config.securityMode });
                }
            }
        };
        OpcuaServersComponent.ctorParameters = function () { return [
            ...
            { type: ngxComponents.ContextRouteComponent, decorators: [{ type: core.Optional }] }
        ]; };
    ...
    var OpcuaAddressSpaceTreeComponent = /** @class */ (function () {
        function OpcuaAddressSpaceTreeComponent(addressSpaceService, opcuaService, alertService) {
            ...
            this.opcuaService = opcuaService;
            this.alertService = alertService;
            this.focusEmitter = new core.EventEmitter();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            clonedAncestors = lodash.clone(selectedAncestorIds);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 6:
                            rootNode = (_b.sent());
                            this.nestedTreeControl = new tree.NestedTreeControl(this.getChildren);
    ...
    var OpcuaAutoApplySettingsComponent = /** @class */ (function () {
        function OpcuaAutoApplySettingsComponent(inventoryService) {
            ...
            this.placeholderSelectServerIds = ngxComponents.gettext('Select server IDs from list');
            this.updateSelectedItem = new core.EventEmitter();
        }
                        ...
                        case 1:
                            ...
                            data.forEach(function (server) {
                                if (matchesServerIds &&
                                    ...
                                    _this.selectedItems.push(server);
                                    _this.checked[server.id] = true;
                                    _this.showServerIds = true;
                                }
                            });
                            return [2 /*return*/];
                    }
        ...
        OpcuaAutoApplySettingsComponent.prototype.updateConstraints = function (items) {
            if (this.constraints) {
                this.constraints.matchesServerIds = items.map(function (item) { return item.id; });
            }
        };
        OpcuaAutoApplySettingsComponent.prototype.filterItems = function (filterText) {
            if (filterText.length !== 0) {
                var search_1 = new RegExp(filterText, 'i');
                this.filteredList = this.opcuaServers.filter(function (_a) {
                    var name = _a.name, id = _a.id;
                    return search_1.test(name) || search_1.test(id);
                });
            }
            else {
        ...
        OpcuaAutoApplySettingsComponent.prototype.isChecked = function (item) {
            return this.checked[item.id];
        };
        OpcuaAutoApplySettingsComponent.prototype.onSelect = function (selected, item) {
            if (!selected) {
                this.selectedItems = lodashEs.reject(this.selectedItems, { id: item.id });
    ...
    var routes = [
        {
            ...
            label: ngxComponents.gettext('OPC UA server'),
            icon: 'server',
        ...
        },
        {
            ...
            label: ngxComponents.gettext('Address space'),
            icon: 'cloud-network',
        ...
        OpcuaProtocolModule = __decorate([
            core.NgModule({
                ...
                imports: [
                    ...
                    ngxComponents.DropAreaModule,
                    buttons.ButtonsModule,
                    tree.CdkTreeModule,
                    router.RouterModule.forRoot(deviceProtocolRoutes, { useHash: true }),
    ...
    var opcuaAddressSpaceTreeComponent = _static.downgradeComponent({
    ...
    exports.AddressSpaceService = AddressSpaceService;
    exports.DynamicDataSource = DynamicDataSource;
    exports.OpcuaAddressSpaceComponent = OpcuaAddressSpaceComponent;
    exports.OpcuaAddressSpaceDetailComponent = OpcuaAddressSpaceDetailComponent;
    exports.OpcuaAddressSpaceTreeComponent = OpcuaAddressSpaceTreeComponent;
    exports.OpcuaAgentGuard = OpcuaAgentGuard;
    exports.OpcuaAutoApplySettingsComponent = OpcuaAutoApplySettingsComponent;
    exports.OpcuaDeviceProtocolBrowsePathValidation = OpcuaDeviceProtocolBrowsePathValidation;
    exports.OpcuaDeviceProtocolDataReportingComponent = OpcuaDeviceProtocolDataReportingComponent;
    exports.OpcuaDeviceProtocolDescription = OpcuaDeviceProtocolDescription;
    exports.OpcuaDeviceProtocolDetailComponent = OpcuaDeviceProtocolDetailComponent;
    exports.OpcuaDeviceProtocolMapping = OpcuaDeviceProtocolMapping;
    exports.OpcuaDeviceProtocolMappingCustomAction = OpcuaDeviceProtocolMappingCustomAction;
    exports.OpcuaDeviceProtocolObjectMapping = OpcuaDeviceProtocolObjectMapping;
    exports.OpcuaDeviceProtocolObjectMappingStatus = OpcuaDeviceProtocolObjectMappingStatus;
    exports.OpcuaMicroserviceGuard = OpcuaMicroserviceGuard;
    exports.OpcuaProtocolModule = OpcuaProtocolModule;
    exports.OpcuaServerConfigComponent = OpcuaServerConfigComponent;
    exports.OpcuaServerGuard = OpcuaServerGuard;
    exports.OpcuaServerListComponent = OpcuaServerListComponent;
    exports.OpcuaServersComponent = OpcuaServersComponent;
...
//# sourceMappingURL=c8y-ngx-components-protocol-opcua.umd.js.map
