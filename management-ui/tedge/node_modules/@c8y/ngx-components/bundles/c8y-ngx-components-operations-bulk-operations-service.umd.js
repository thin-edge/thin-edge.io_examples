(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('lodash-es'), require('rxjs'), require('@c8y/client')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/operations/bulk-operations-service', ['exports', '@angular/core', '@angular/common', 'lodash-es', 'rxjs', '@c8y/client'], factory) :
    (global = global || self, factory((global.c8y = global.c8y || {}, global.c8y['ngx-components'] = global.c8y['ngx-components'] || {}, global.c8y['ngx-components'].operations = global.c8y['ngx-components'].operations || {}, global.c8y['ngx-components'].operations['bulk-operations-service'] = {}), global.ng.core, global.ng.common, global.lodashEs, global.rxjs, global.client));
}(this, (function (exports, core, common, lodashEs, rxjs, client) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var HOOK_LIST_BULK_TYPE = new core.InjectionToken('LIST_BULK_TYPE');
    var BulkOperationsService = /** @class */ (function () {
        function BulkOperationsService(operationBulkService, operationService, inventoryService, location, bulkTypes) {
            ...
            this.firmwareId = new rxjs.Subject();
            this.bulkTypes = lodashEs.flatten(bulkTypes);
            this.bulkTypes = this.bulkTypes.map(function (type) {
                if (lodashEs.isUndefined(type.selected)) {
                    type.selected = false;
                }
                return type;
            });
        ...
        BulkOperationsService.prototype.retrieveBulkOperationType = function (operation) {
            ...
            this.bulkTypes.some(function (t) {
                if (t.fragments.some(function (fragment) { return lodashEs.has(operation, fragment); })) {
                    type = t.type;
                    return true;
                }
            });
        ...
        BulkOperationsService.ctorParameters = function () { return [
            { type: client.OperationBulkService },
            { type: client.OperationService },
            { type: client.InventoryService },
            { type: common.Location },
            { type: Array, decorators: [{ type: core.Optional }, { type: core.Inject, args: [HOOK_LIST_BULK_TYPE,] }] }
        ]; };
        BulkOperationsService = __decorate([
            core.Injectable(),
            __param(4, core.Optional()), __param(4, core.Inject(HOOK_LIST_BULK_TYPE))
    ...
    })(exports.BulkOperationType || (exports.BulkOperationType = {}));

    exports.BulkOperationsService = BulkOperationsService;
    exports.BulkOperationsServiceModule = BulkOperationsServiceModule;
    exports.HOOK_LIST_BULK_TYPE = HOOK_LIST_BULK_TYPE;
    exports.baseUrl = baseUrl;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=c8y-ngx-components-operations-bulk-operations-service.umd.js.map
