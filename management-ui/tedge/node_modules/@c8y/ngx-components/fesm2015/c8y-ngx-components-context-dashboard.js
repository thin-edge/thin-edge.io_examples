...
import { InjectionToken, Inject, ɵɵdefineInjectable, ɵɵinject, Injectable, ViewChild, Component, Input, EventEmitter, Output, Renderer2, HostBinding, NgModule, Host } from '@angular/core';
import { cloneDeep, sortBy, assign, pick, some, keys, keyBy, has, get, forEach, clone, omit, escapeRegExp, findIndex, values, kebabCase } from 'lodash-es';
...
import { gettext, DynamicComponentService, Status, NavigatorNode, getActivatedRoute, ViewContext, TabsService, ModalService, AppStateService, NavigatorService, Permissions, ICON_LIST, DashboardChildChange, AlertService, GainsightService, HOOK_ONCE_ROUTE, HOOK_ACTION, CoreModule, FilterInputComponent, DocsService, DocsModule, QuickLinkModule, HOOK_NAVIGATOR_NODES, HOOK_COMPONENTS } from '@c8y/ngx-components';
...
WidgetService.ngInjectableDef = ɵɵdefineInjectable({ factory: function WidgetService_Factory() { return new WidgetService(ɵɵinject(DynamicComponentService), ɵɵinject(TranslateService), ɵɵinject(CONTEXT_DASHBOARD_CONFIG)); }, token: WidgetService, providedIn: "root" });
WidgetService = __decorate([
    Injectable({
        providedIn: 'root'
    }),
    __param(2, Inject(CONTEXT_DASHBOARD_CONFIG))
], WidgetService);
...
let DeviceDashboardGuard = class DeviceDashboardGuard {
...
let GroupDashboardGuard = class GroupDashboardGuard {
    constructor(contextDashboardService) {
        this.contextDashboardService = contextDashboardService;
    }
    canActivate(route) {
...
let WidgetPreviewComponent = class WidgetPreviewComponent {
    constructor() {
        this.previewClasses = {
...
ContextDashboardComponent = __decorate([
    ...
    __param(5, Inject(CONTEXT_DASHBOARD_CONFIG))
...
let ReportDashboardService = class ReportDashboardService {
...
ReportDashboardService = __decorate([
    Injectable()
...
ReportDashboardListComponent = __decorate([
    Component({
...
let LegacyWelcomeComponent = class LegacyWelcomeComponent {
...
ReportDashboardGuard = __decorate([
    Injectable()
...
ReportDashboardNavigationFactory = __decorate([
    Injectable()
...
ReportDashboardModule = __decorate([
    NgModule({
...
export { AppearanceSettingsComponent, CONTEXT_DASHBOARD_CONFIG, CockpitDashboardComponent, CockpitDashboardModule, ContextDashboardComponent, ContextDashboardModule, ContextDashboardService, ContextDashboardType, DASHBOARD_THEME_CLASSES, DashboardActionsFactory, DashboardDetailComponent, DeviceDashboardGuard, GroupDashboardGuard, LegacyWelcomeComponent, ReportDashboardGuard, ReportDashboardListComponent, ReportDashboardModule, ReportDashboardNavigationFactory, ReportDashboardService, WIDGET_CONTENT_CLASSES, WIDGET_HEADER_CLASSES, WelcomeToCockpit, WidgetConfigComponent, WidgetPreviewComponent, WidgetService, ɵ0, ɵ1, ɵ2 };
