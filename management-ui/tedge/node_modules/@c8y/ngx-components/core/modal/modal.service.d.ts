...
export declare class ModalService {
     ...
     */
    confirm(title: string, body: string, status?: StatusType, labels?: any): Promise<any>;
    /**
     ...
     */
    acknowledge(title: string, body: string, status?: StatusType, acknowledgeLabel?: string): Promise<any>;
}
