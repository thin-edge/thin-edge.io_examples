...
export declare class HeaderService extends StateService {
    ...
    title: any;
    constructor(navigatorService: NavigatorService, options: OptionsService);
    readonly state: Header;
    readonly navigatorHiddenOnStartup: boolean;
    readonly largeWidth: boolean;
