...
int main(int argc, char* argv[]) {
    ...
    const char* mqtt_host = "didier.latest.stage.c8y.io";
    ...
    conn_opts.username = "t398942/didier";
    conn_opts.password = getpass("Password: ");
    ...
    //create device
    publish(client, "s/us", "100,BME_280,c8y_MQTTDevice");
    //set hardware information
    publish(client, "s/us", "110,S123456789,BME_280 test,Rev0.1");
    ...
    for (;;) {
        ...
        snprintf(buffer, sizeof(buffer), "211,%.2f", comp_data.temperature);
